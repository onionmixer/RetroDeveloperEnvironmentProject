#!/usr/bin/env bash
# 02_consolehello — MSX-DOS2 .COM launcher in openMSX
...
WORK_DIR="${WORK_DIR:-/tmp/02_consolehello_dos}"
mkdir -p "$WORK_DIR"
...
echo "Starting 02_consolehello in MSX-DOS2..."
echo "  COM:     $COM"
echo "  Disk:    $WORK_DISK"
