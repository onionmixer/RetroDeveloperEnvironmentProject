#!/usr/bin/env bash
# 01_hello — ROM cartridge launcher in openMSX
...
ROM_PATH="${ROM_PATH:-$SCRIPT_DIR/build/01_hello.rom}"
...
echo "Starting 01_hello ROM in openMSX..."
echo "  ROM:     $ROM_PATH"
echo "  Machine: $MACHINE"

# 32 KiB plain cartridge — no -romtype needed (Konami mapper not used)
