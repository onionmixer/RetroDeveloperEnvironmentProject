...
DISK_IMAGE="${DISK_IMAGE:-$BUILD_DIR/prototype_01_appleii_prodos.po}"
...
build() {
  ...
  cl65 -t apple2 -O -o HELLO src/main.c src/game.c src/room_data.c
...
Usage: $0 [build|disk|run|clean|all]
  build : generate room data + build HELLO
