...
- AppleWin Debug Server: `Emulator/AppleWin/source/debugserver/`
- openMSX Debug HTTP: `Emulator/openMSX/src/debugger/`
- rdemonitor (클라이언트 구현): `RetroDeveloperEnvironmentMonitor/`
